...
<div class="login-container">
	...
	<div class="login-form">
        ...
        <div class="modal-body">
		 Thanks for having interest in our software. To purhase this software, click on Buy Now Button Below to Purchase. Note that once your payment is succesfully, download link will be sent to your email address immediately, so you are required to type correct email address while during the payment process.</div> OR chat with us on watsapp, telegram on +23426634951, +2348161662924 OR message to digiproblemsolver@gmail.com.
		 <br>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form method="POST" action="https://voguepay.com/pay/" target="_blank"><input type="hidden" name="v_merchant_id" value="1567-0045444" /><input type="hidden" name="memo" value="Order from digi LINKUP COMPUTER" /><input type="hidden" name="cur" value="NGN" /><input type="hidden" name="item_1" value="Software" /><input type="hidden" name="price_1" value="20000" /><input type="hidden" name="description_1" value="You are about to purchase latest single licence school management system from Digi Linkup Computers. Kindly supply your card details to continue" /><br /><input type="image" src="https://voguepay.com/images/buttons/buynow_red.png" alt="PAY" /></form>
       <hr>
	   <div align="center">
